...
options:
  ...
  -q, --quiet           suppress normal summary output to stdout. (Default is
                        False)
  -y, --quietmoduledocstring     suppress production of Module DocString test  ## XAM
...
<BLANKLINE>
    ...
    $Id: processargs.py,v 1.3 2009/10/14 18:32:41 xavier Exp $
"""
...
from PyMetrics.doctestsw import *
...
class ProcessArgs:
    ...
    def __init__( self,
        ...
        inFileList = None
        includeMetricsStr = 'simple:SimpleMetric,mccabe:McCabeMetric,sloc:SLOCMetric:halstead:HalsteadMetric'
        excludeMetricsStr = None
        debugSw = False
        debugSw = False
        quietSw = False
        quietModDocStringSw = False
        zeroSw = False
        genBasicSw = True
        genKwCntSw = False
        genSqlSw = True
        ...
        parser = PyMetricsOptionParser( '', version="%prog 0.8.2.1" )
        ...
        parser.add_option("-y", "--quietmoduledocstring",
                          action="store_true", 
                          dest="quietModDocStringSw", 
                          default=self.quietModDocStringSw,
                          help="suppress normal summary output concerning Missing Module DocString. (Default is %s)" % (not self.quietModDocStringSw) )
