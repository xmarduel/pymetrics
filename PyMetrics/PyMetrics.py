...
""" PyMetrics - Complexity Measurements for Python code.
    ...
    $Id: PyMetrics.py,v 1.1.1.1 2009/10/10 08:22:31 xavier Exp $
"""
__revision__ = "$Id: PyMetrics.py,v 1.1.1.1 2009/10/10 08:22:31 xavier Exp $"
