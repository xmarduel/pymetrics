""" Utility functions used throughout the PyMetrics system.
    ...
    $Id: utils.py,v 1.2 2009/10/10 08:54:24 xavier Exp $
"""
...
def sqlQ( s ):
    """ Place single quotes around strings and escaping existing single quotes. Escape double quote with two double quotes."""
    a = s.replace( "\\","\\\\" )
    a = a.replace( "'", "\\'" )
    a = a.replace( '"', '""' )
    return '"'+a+'"'
